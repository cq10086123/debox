...
"CREATE TABLE IF NOT EXISTS `{$db_pre}app` (
  ...
  `logon_check_t` varchar(10) DEFAULT '24' COMMENT '登录换绑机器码间隔',
  ...
  `app_bb_mobile` varchar(10) DEFAULT '1.0' COMMENT 'mobileAPP版本',
  `app_nshow_mobile` text COMMENT 'mobile更新内容',
  `app_nurl_mobile` varchar(255) DEFAULT NULL COMMENT 'mobile更新地址',
  ...
  `ui_state_live` enum('y','n') DEFAULT 'n' COMMENT '后台直播控制',
  `ui_state_jkjxkg` enum('y','n') DEFAULT 'y' COMMENT '是否开启接口自带解析',
  `ui_state_livevip` enum('y','n') DEFAULT 'n' COMMENT '是否开启只有vip才可以打开直播',
  `ui_state_infojm` enum('y','n') DEFAULT 'y' COMMENT '调试用,默认打开',
  `ui_state_jk` enum('y','n') DEFAULT 'n' COMMENT '后台接口加密',
  `ui_state_dcjm` enum('y','n') DEFAULT 'n' COMMENT '后台多仓接口加密',
  ...
  `app_jsonc` varchar(255) DEFAULT '' COMMENT '多线路聚合接口',
  `ad_slide` varchar(255) DEFAULT '1' COMMENT 'TV选择轮播或幻灯片',
  `ad_slide_mobile` varchar(255) DEFAULT '1' COMMENT 'mobile选择轮播或幻灯片',
  `ad_slide_soundkg` varchar(255) DEFAULT '0.5' COMMENT '幻灯片视频声音开关',
  `free_time` varchar(255) DEFAULT '360' COMMENT '试看时间单位为秒',
  `free_time_tip` varchar(255) DEFAULT '60' COMMENT '试看提示自动消失时间为秒',
  `isToPay` varchar(255) DEFAULT 'false' COMMENT 'false试看结束返回详情页，true支付页',
  `isNoticeShow` varchar(255) DEFAULT '1' COMMENT '1 为多条消息垂直轮播 其他数字为原始跑马灯',
  `livePass` varchar(255) DEFAULT '0123456789abcdef|0123456789abcdef' COMMENT '直播加密key|iv',
  `liveUrl` varchar(255) DEFAULT '' COMMENT '直播地址',
  `play_tips` varchar(255) DEFAULT '' COMMENT '播放视频顶部提示信息',
  ...
  `ui_kefu_mobile` varchar(255) DEFAULT '' COMMENT 'mobile我的-联系客服',
  `ui_kefu2` varchar(255) DEFAULT '' COMMENT '添加公众号',
  `ui_button3backg` varchar(255) DEFAULT '' COMMENT '按钮3背景',
  `ui_buttonadimg` varchar(255) DEFAULT '' COMMENT '按钮3弹窗',
  `ui_button3backg2` varchar(255) DEFAULT '' COMMENT '按钮3背景2',
  `ui_buttonadimg2` varchar(255) DEFAULT '' COMMENT '按钮3弹窗2',
  `ui_button3backg3` varchar(255) DEFAULT '' COMMENT '按钮3背景3',
  `ui_buttonadimg3` varchar(255) DEFAULT '' COMMENT '按钮3弹窗3',
  `ui_vipdc` varchar(255) DEFAULT '' COMMENT '多仓vip线路',
  `ui_vipdc_zdmc` varchar(255) DEFAULT '' COMMENT '多仓指定账号线路',
  `ui_vipdc_zdzh` varchar(255) DEFAULT '' COMMENT '多仓线路指定账号',
  `ui_vipdc_zdzhpass` varchar(255) DEFAULT '123456' COMMENT '多仓线路指定线路密码',
  `ui_vipzb` varchar(255) DEFAULT '' COMMENT '直播多仓vip线路',
  `ui_vipzb_zdmc` varchar(255) DEFAULT '' COMMENT '直播多仓指定账号线路',
  `ui_vipzb_zdzh` varchar(255) DEFAULT '' COMMENT '直播多仓线路指定账号',
  `ui_vipzb_zdzhpass` varchar(255) DEFAULT '123456' COMMENT '直播多仓线路指定线路密码',
  `ui_group` varchar(255) DEFAULT '' COMMENT '用户群',
  `ui_group_mobile` varchar(255) DEFAULT '' COMMENT 'mobile我的-官方QQ群',
  `ui_logo` varchar(255) DEFAULT '' COMMENT '全局LOGO',
  `ui_startad_bj` varchar(255) DEFAULT '' COMMENT '全局背景图tv',
  `ui_startad` varchar(255) DEFAULT '' COMMENT 'TV启动广告',
  `ui_startad_mobile` varchar(255) DEFAULT '' COMMENT 'mobile启动广告',
  `ui_startad_time` int(10) DEFAULT '5' COMMENT '启动广告显示时间',
  `ui_startad_hdptime` int(10) DEFAULT '5' COMMENT '启动广告显示时间',
  `ui_app_banner` varchar(255) DEFAULT '' COMMENT 'logo',
  ...
  `ui_remove_adjx` varchar(255) DEFAULT '' COMMENT '去量子 非凡等资源站插播视频广告',
...
"CREATE TABLE IF NOT EXISTS `{$db_pre}app_exten` (
  ...
  `statejm` enum('y','n') DEFAULT 'y' COMMENT '接口状态',
  PRIMARY KEY (`id`),
...
"CREATE TABLE IF NOT EXISTS `{$db_pre}app_homead` (
  ...
  `name` varchar(128) NOT NULL COMMENT '变量名',
  `data` text NOT NULL COMMENT '数据',
  `type` enum('img','video','gif') NOT NULL COMMENT '默认类型',
  `appid` int(10) NOT NULL,
  `searchable` int(10) DEFAULT '0' COMMENT '可否搜索',
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
...
"CREATE TABLE IF NOT EXISTS `{$db_pre}app_duocang` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(128) NOT NULL COMMENT '变量名',
  `url` varchar(255) NOT NULL COMMENT '链接',
  `appid` int(10) NOT NULL,
  `status` enum('y','n') DEFAULT 'y' COMMENT '状态',
  `status_dcjm` enum('y','n') DEFAULT 'y' COMMENT '是否加密',
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;"
,

"CREATE TABLE IF NOT EXISTS `{$db_pre}app_zb` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(128) NOT NULL COMMENT '变量名',
  `url` varchar(255) NOT NULL COMMENT '链接',
  `appid` int(10) NOT NULL,
  `status` enum('y','n') DEFAULT 'y' COMMENT '状态',
  `status_zbjm` enum('y','n') DEFAULT 'y' COMMENT '是否加密',
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;"
,
"CREATE TABLE IF NOT EXISTS `{$db_pre}captcha` (
  ...
  `time` varchar(10) NOT NULL COMMENT '时间戳',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;"
,
...
"CREATE TABLE IF NOT EXISTS `{$db_pre}site` (
  ...
  `playerType` enum('IJK','EXO') NOT NULL COMMENT '默认播放器',
  ...
  `sitejm` int(10) DEFAULT '0' COMMENT '是否加密',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;"
,
...
"CREATE TABLE IF NOT EXISTS `{$db_pre}kami` (
  ...
  `use_time` varchar(10) DEFAULT '0' COMMENT '使用时间',
  `end_time` varchar(10) DEFAULT '0' COMMENT '结束时间',
...
"CREATE TABLE IF NOT EXISTS `{$db_pre}user` (
  ...
  `vip` varchar(10) DEFAULT '0' COMMENT 'VIP时间戳',
...
"CREATE TABLE IF NOT EXISTS `{$db_pre}log` (
  ...
  `vip` varchar(10) DEFAULT '0' COMMENT 'VIP变化',
