...
/*
 * 本程序由 Xiaojie_jiami_zym 解密
 * 官网地址：decode.xiaojieapi.com
 * 官方群号：809513269
 * 当前时间：2025-05-16 20:48:29
        ...
        <div class="wrapper">
            ...
            <div class="left-side-menu">
                <div class="leftbar-user">
                    <a href="#">
                        <img src="../assets/images/users/avatar-1.png" alt="user-image" height="42" class="rounded-circle shadow-sm">
...
foreach ($menu as $val) {
    if (!isset($val['side-nav-second-level'])) {
        ...
        ?> href="javascript: void(0);" class="side-nav-link">
                                    <i class="<?php 
        echo $val['icons'];
        ?>"></i>
                                    <span><?php 
        ...
        ?> class="side-nav-second-level" aria-expanded="false">
                                    <?php 
