			...
			<div class="card-body">
				<form action="" method="post" id="addimg" name="addimg">
					<div class="form-row">
						...
						<div class="form-group col-md-12">
							<label>修改用户昵称</label>
							<input name="name" id="name" type="text" class="form-control" placeholder="空则不修改" value="">
						</div>
						<div class="form-group col-md-12">
							<label>用户密码</label>
                        ...
                        <div class="form-group col-md-12">
                            <label>用户邮箱</label>
                            <input name="email" id="email" type="text" class="form-control" placeholder="空则不修改" value="<?php echo $res['email']; ?>">
                        </div>
						...
						<div class="form-group col-md-6">
							...
							<span class="font-13 text-muted">永久会员格式填写 "9999/99/99"</span>
						</div>
						<div class="form-group col-md-6">
							<label>积分</label>
